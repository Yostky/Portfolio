...
window.addEventListener('scroll', ()=> {
    ...
    sections.forEach(section => {
        ...
        if(pageYOffset >= (sectionTop - height / 3)){
...
function onecall(lat, lon) {
    let weatherApiUrl = fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&units=imperial&appid=4edd74c5cec3113209554fa2045fdb73`);
